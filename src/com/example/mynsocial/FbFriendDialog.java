...
public class FbFriendDialog extends Dialog
{
	...
	public static String					DIALOG_BASE_URL				= "https://m.facebook.com/app_scoped_user_id/";
...
//		mUrl = formatURL(userId);
		Log.d("FacebookSampleActivity", "++++++++++++++++++++"+userId);
		mUrl = DIALOG_BASE_URL+userId;
//		mUrl = "http://m.facebook.com/trashprc";
		Log.i("FacebookSampleActivity", mUrl);
		mListener = listener;
	}
